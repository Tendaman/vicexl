...
export async function generateMetadata({
  ...
  let title = "ViceXL";
  let description =
    "ViceXL helps creators turn regular content into interactive AI experiences, effortlessly capturing leads, and nurturing them towards your digital products or courses.";
  let openGraphImage;
